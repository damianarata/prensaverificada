...
<body class="bg-gray-100 flex flex-col min-h-screen">
    ...
    <div class="flex-grow">
        <div class="container mx-auto p-8">
            ...
            <div class="mb-8" onclick="window.location.href='./Publicacion.aspx'">
                <div class="relative">
                    <img src="./img/diputados.webp" alt="Imagen Principal" class="w-full h-64 object-cover rounded-lg shadow-md">
                    <div class="absolute inset-0 bg-black bg-opacity-50 flex items-end rounded-lg">
                        <div class="p-6 text-white">
                            ...
                            <div class="flex items-center mt-4">
                                <img src="img/alconada.webp" alt="Autor" class="w-10 h-10 rounded-full mr-4">
                                <div>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <div class="bg-white p-4 rounded-lg shadow-md" onclick="window.location.href='./Publicacion.aspx'">
                    <img src="img/cripto.webp" alt="Criptomonedas" class="w-full h-32 object-cover rounded-lg mb-4">
                ...
                <!-- Repetir este bloque para cada artículo -->
                <div class="bg-white p-4 rounded-lg shadow-md" onclick="window.location.href='./Publicacion.aspx'">
                    <img src="img/javier-adorni.webp" alt="Politica" class="w-full h-32 object-cover rounded-lg mb-4">
                ...
                <!-- Repetir este bloque para cada artículo -->
                <div class="bg-white p-4 rounded-lg shadow-md" onclick="window.location.href='./Publicacion.aspx'">
                    <img src="img/inversiones.webp" alt="Criptomonedas" class="w-full h-32 object-cover rounded-lg mb-4">
                    <span class="block text-blue-600 text-sm font-semibold mb-2">Finanzas</span>
                ...
                <!-- Repetir este bloque para cada artículo -->
                <div class="bg-white p-4 rounded-lg shadow-md" onclick="window.location.href='./Publicacion.aspx'">
                    <img src="img/mbappe.webp" alt="Deportes" class="w-full h-32 object-cover rounded-lg mb-4">
                ...
                <!-- Repetir este bloque para cada artículo -->
                <div class="bg-white p-4 rounded-lg shadow-md" onclick="window.location.href='./Publicacion.aspx'">
                    <img src="img/netflix-peliculas-7jpg.webp" alt="Streaming" class="w-full h-32 object-cover rounded-lg mb-4">
                ...
                <!-- Repetir este bloque para cada artículo -->
                <div class="bg-white p-4 rounded-lg shadow-md" onclick="window.location.href='./Publicacion.aspx'">
                    <img src="img/dolar.webp" alt="Economia" class="w-full h-32 object-cover rounded-lg mb-4">
                ...
                <!-- Repetir este bloque para cada artículo -->
                <div class="bg-white p-4 rounded-lg shadow-md" onclick="window.location.href='./Publicacion.aspx'">
                    <img src="img/apple.webp" alt="Tecnologia" class="w-full h-32 object-cover rounded-lg mb-4">
                ...
                <div class="bg-white p-4 rounded-lg shadow-md" onclick="window.location.href='./Publicacion.aspx'">
                    ...
                    <div class="flex items-center mt-4">
                        <img src="img/tenembaum.webp" alt="Autor" class="w-8 h-8 rounded-full mr-2">
                        <div>
                            <p class="text-sm font-semibold">Tracey Wilson</p>
                            <p class="text-sm text-gray-600">4 de junio de 2024</p>
                        </div>
                ...
                <!-- Repetir este bloque para cada artículo -->
                <div class="bg-white p-4 rounded-lg shadow-md" onclick="window.location.href='./Publicacion.aspx'">
                    <img src="img/sele-arg.webp" alt="Deportes" class="w-full h-32 object-cover rounded-lg mb-4">
                    <span class="block text-blue-600 text-sm font-semibold mb-2">Deportes</span>
